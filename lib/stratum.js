...
var StratumClient = function(options){
    ...
    function handleAuthorize(message, replyToSocket){
        ...
        var addr = _this.workerName.split(".")[0]; //TODO should we do this? authorizeFn Already splits the workerName
        ...
        _this.emit('submit',
            {
                ...
                extraNonce2 : message.params[2].toLowerCase(),
                nTime       : message.params[3].toLowerCase(),
                nonce       : message.params[4].toLowerCase()
            },
            // TODO lie to Claymore miner due to unauthorized devfee submissions - update result below to true
